...
const navigation: NavSection[] = [
  {
    title: 'AURA OS',
    items: [
    { to: '/dashboard', label: 'Executive Experience', icon: Sparkles, end: true },
  ...
  return (
    <div className={`min-h-screen bg-deep-space text-slate-100 lg:grid ${collapsed ? 'lg:grid-cols-[92px_1fr]' : 'lg:grid-cols-[284px_1fr]'}`}>
      <aside className="hidden border-r border-white/[0.07] bg-[#0b0d19] p-4 lg:flex lg:flex-col">
        ...
        {!collapsed && <div className="mt-6 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 text-xs leading-5 text-slate-500">AURA FIRST ACCESS 1.0<br />Interface oficial</div>}
      </aside>
